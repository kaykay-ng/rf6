    ...
    <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 24 }]}>
      ...
      <View style={styles.body}>
        ...
        <Text variant="body" style={styles.hint}>
          Enter your grid address — you'll find it on the site signage. Example: C5-3
        </Text>
        {/* Address input + map preview coming in next task */}
      </View>

      <Pressable style={styles.nextBtn} onPress={() => router.push('/onboarding/profile')}>
